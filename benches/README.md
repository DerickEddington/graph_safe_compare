...
running 66 tests
test basic::degenerate_dag::equiv                        ... bench:   4,567,525 ns/iter (+/- 100,557)
test basic::degenerate_dag::limited_equiv                ... bench:   4,846,149 ns/iter (+/- 239,602)
test basic::inverted_list::equiv                         ... bench:     216,529 ns/iter (+/- 30,710)
test basic::inverted_list::limited_equiv                 ... bench:     211,603 ns/iter (+/- 42,874)
test basic::list::equiv                                  ... bench:     195,734 ns/iter (+/- 31,494)
test basic::list::limited_equiv                          ... bench:     206,438 ns/iter (+/- 26,018)
test basic::short_degenerate_dag::equiv                  ... bench:       2,283 ns/iter (+/- 102)
test basic::short_degenerate_dag::limited_equiv          ... bench:       2,387 ns/iter (+/- 79)
test basic::short_inverted_list::equiv                   ... bench:       1,936 ns/iter (+/- 34)
test basic::short_inverted_list::limited_equiv           ... bench:       2,043 ns/iter (+/- 111)
test basic::short_list::equiv                            ... bench:       1,978 ns/iter (+/- 68)
test basic::short_list::limited_equiv                    ... bench:       2,102 ns/iter (+/- 66)
test cycle_safe::degenerate_cyclic::equiv                ... bench:       3,085 ns/iter (+/- 164)
test cycle_safe::degenerate_cyclic::precheck_equiv       ... bench:       9,186 ns/iter (+/- 536)
test cycle_safe::degenerate_dag::equiv                   ... bench:       3,043 ns/iter (+/- 146)
test cycle_safe::degenerate_dag::precheck_equiv          ... bench:       6,898 ns/iter (+/- 331)
test cycle_safe::inverted_list::equiv                    ... bench:     284,784 ns/iter (+/- 55,221)
test cycle_safe::inverted_list::precheck_equiv           ... bench:     292,093 ns/iter (+/- 57,447)
test cycle_safe::list::equiv                             ... bench:     283,734 ns/iter (+/- 58,479)
test cycle_safe::list::precheck_equiv                    ... bench:     288,856 ns/iter (+/- 74,244)
test cycle_safe::short_degenerate_cyclic::equiv          ... bench:       1,380 ns/iter (+/- 58)
test cycle_safe::short_degenerate_cyclic::precheck_equiv ... bench:       7,226 ns/iter (+/- 284)
test cycle_safe::short_degenerate_dag::equiv             ... bench:       1,333 ns/iter (+/- 94)
test cycle_safe::short_degenerate_dag::precheck_equiv    ... bench:       2,384 ns/iter (+/- 67)
test cycle_safe::short_inverted_list::equiv              ... bench:       6,867 ns/iter (+/- 334)
test cycle_safe::short_inverted_list::precheck_equiv     ... bench:       2,041 ns/iter (+/- 48)
test cycle_safe::short_list::equiv                       ... bench:       4,732 ns/iter (+/- 292)
test cycle_safe::short_list::precheck_equiv              ... bench:       2,081 ns/iter (+/- 56)
test deep_safe::degenerate_dag::equiv                    ... bench:   5,385,036 ns/iter (+/- 437,525)
test deep_safe::inverted_list::equiv                     ... bench:     150,477 ns/iter (+/- 10,144)
test deep_safe::list::equiv                              ... bench:     144,383 ns/iter (+/- 7,797)
test deep_safe::long_inverted_list::equiv                ... bench:   7,620,241 ns/iter (+/- 521,728)
test deep_safe::long_list::equiv                         ... bench:   5,228,874 ns/iter (+/- 406,785)
test deep_safe::short_degenerate_dag::equiv              ... bench:       2,382 ns/iter (+/- 32)
test deep_safe::short_inverted_list::equiv               ... bench:       1,847 ns/iter (+/- 84)
test deep_safe::short_list::equiv                        ... bench:       1,842 ns/iter (+/- 76)
test derived_eq::degenerate_dag::eq                      ... bench:   1,189,864 ns/iter (+/- 65,749)
test derived_eq::inverted_list::eq                       ... bench:      73,840 ns/iter (+/- 21,716)
test derived_eq::list::eq                                ... bench:      73,119 ns/iter (+/- 4,361)
test derived_eq::short_degenerate_dag::eq                ... bench:         565 ns/iter (+/- 29)
test derived_eq::short_inverted_list::eq                 ... bench:         744 ns/iter (+/- 30)
test derived_eq::short_list::eq                          ... bench:         469 ns/iter (+/- 15)
test robust::degenerate_cyclic::equiv                    ... bench:       3,236 ns/iter (+/- 272)
test robust::degenerate_cyclic::precheck_equiv           ... bench:       7,642 ns/iter (+/- 223)
test robust::degenerate_dag::equiv                       ... bench:       3,132 ns/iter (+/- 93)
test robust::degenerate_dag::precheck_equiv              ... bench:       6,816 ns/iter (+/- 177)
test robust::inverted_list::equiv                        ... bench:     216,805 ns/iter (+/- 24,477)
test robust::inverted_list::precheck_equiv               ... bench:     223,078 ns/iter (+/- 16,396)
test robust::list::equiv                                 ... bench:     214,694 ns/iter (+/- 35,350)
test robust::list::precheck_equiv                        ... bench:     221,537 ns/iter (+/- 18,593)
test robust::long_degenerate_cyclic::equiv               ... bench: 113,177,265 ns/iter (+/- 10,988,489)
test robust::long_degenerate_cyclic::precheck_equiv      ... bench: 113,857,289 ns/iter (+/- 10,682,160)
test robust::long_degenerate_dag::equiv                  ... bench: 112,801,244 ns/iter (+/- 11,702,132)
test robust::long_degenerate_dag::precheck_equiv         ... bench: 113,181,221 ns/iter (+/- 10,603,560)
test robust::long_inverted_list::equiv                   ... bench:  13,458,660 ns/iter (+/- 1,412,418)
test robust::long_inverted_list::precheck_equiv          ... bench:  12,861,986 ns/iter (+/- 1,887,157)
test robust::long_list::equiv                            ... bench:   9,720,576 ns/iter (+/- 1,945,144)
test robust::long_list::precheck_equiv                   ... bench:  15,711,694 ns/iter (+/- 1,700,184)
test robust::short_degenerate_cyclic::equiv              ... bench:       1,472 ns/iter (+/- 65)
test robust::short_degenerate_cyclic::precheck_equiv     ... bench:       5,948 ns/iter (+/- 295)
test robust::short_degenerate_dag::equiv                 ... bench:       1,398 ns/iter (+/- 62)
test robust::short_degenerate_dag::precheck_equiv        ... bench:       2,472 ns/iter (+/- 115)
test robust::short_inverted_list::equiv                  ... bench:       6,574 ns/iter (+/- 246)
test robust::short_inverted_list::precheck_equiv         ... bench:       1,876 ns/iter (+/- 88)
test robust::short_list::equiv                           ... bench:       4,468 ns/iter (+/- 216)
test robust::short_list::precheck_equiv                  ... bench:       1,868 ns/iter (+/- 63)

test result: ok. 0 passed; 0 failed; 0 ignored; 66 measured; 0 filtered out; finished in 265.30s
```
