...
running 66 tests
test basic::degenerate_dag::equiv                        ... bench:   3,932,394 ns/iter (+/- 155,246)
test basic::degenerate_dag::limited_equiv                ... bench:   4,003,613 ns/iter (+/- 185,552)
test basic::inverted_list::equiv                         ... bench:     164,679 ns/iter (+/- 34,418)
test basic::inverted_list::limited_equiv                 ... bench:     176,459 ns/iter (+/- 25,377)
test basic::list::equiv                                  ... bench:     160,078 ns/iter (+/- 35,893)
test basic::list::limited_equiv                          ... bench:     163,574 ns/iter (+/- 16,057)
test basic::short_degenerate_dag::equiv                  ... bench:       1,953 ns/iter (+/- 29)
test basic::short_degenerate_dag::limited_equiv          ... bench:       1,884 ns/iter (+/- 77)
test basic::short_inverted_list::equiv                   ... bench:       1,866 ns/iter (+/- 42)
test basic::short_inverted_list::limited_equiv           ... bench:       1,785 ns/iter (+/- 29)
test basic::short_list::equiv                            ... bench:       1,614 ns/iter (+/- 73)
test basic::short_list::limited_equiv                    ... bench:       1,767 ns/iter (+/- 83)
test cycle_safe::degenerate_cyclic::equiv                ... bench:       2,925 ns/iter (+/- 122)
test cycle_safe::degenerate_cyclic::precheck_equiv       ... bench:       7,242 ns/iter (+/- 62)
test cycle_safe::degenerate_dag::equiv                   ... bench:       2,953 ns/iter (+/- 94)
test cycle_safe::degenerate_dag::precheck_equiv          ... bench:       6,315 ns/iter (+/- 265)
test cycle_safe::inverted_list::equiv                    ... bench:     242,336 ns/iter (+/- 16,750)
test cycle_safe::inverted_list::precheck_equiv           ... bench:     260,022 ns/iter (+/- 62,685)
test cycle_safe::list::equiv                             ... bench:     230,590 ns/iter (+/- 54,736)
test cycle_safe::list::precheck_equiv                    ... bench:     234,732 ns/iter (+/- 71,152)
test cycle_safe::short_degenerate_cyclic::equiv          ... bench:       1,314 ns/iter (+/- 51)
test cycle_safe::short_degenerate_cyclic::precheck_equiv ... bench:       5,470 ns/iter (+/- 230)
test cycle_safe::short_degenerate_dag::equiv             ... bench:       1,246 ns/iter (+/- 40)
test cycle_safe::short_degenerate_dag::precheck_equiv    ... bench:       2,091 ns/iter (+/- 47)
test cycle_safe::short_inverted_list::equiv              ... bench:       6,501 ns/iter (+/- 297)
test cycle_safe::short_inverted_list::precheck_equiv     ... bench:       1,927 ns/iter (+/- 57)
test cycle_safe::short_list::equiv                       ... bench:       4,233 ns/iter (+/- 189)
test cycle_safe::short_list::precheck_equiv              ... bench:       1,835 ns/iter (+/- 85)
test deep_safe::degenerate_dag::equiv                    ... bench:   4,004,548 ns/iter (+/- 146,041)
test deep_safe::inverted_list::equiv                     ... bench:     131,379 ns/iter (+/- 22,274)
test deep_safe::list::equiv                              ... bench:     150,198 ns/iter (+/- 33,973)
test deep_safe::long_inverted_list::equiv                ... bench:   7,553,811 ns/iter (+/- 252,631)
test deep_safe::long_list::equiv                         ... bench:   5,075,077 ns/iter (+/- 436,707)
test deep_safe::short_degenerate_dag::equiv              ... bench:       2,022 ns/iter (+/- 45)
test deep_safe::short_inverted_list::equiv               ... bench:       1,591 ns/iter (+/- 7)
test deep_safe::short_list::equiv                        ... bench:       1,487 ns/iter (+/- 67)
test derived_eq::degenerate_dag::eq                      ... bench:   1,176,500 ns/iter (+/- 51,740)
test derived_eq::inverted_list::eq                       ... bench:      68,756 ns/iter (+/- 17,694)
test derived_eq::list::eq                                ... bench:      68,985 ns/iter (+/- 22,427)
test derived_eq::short_degenerate_dag::eq                ... bench:         578 ns/iter (+/- 8)
test derived_eq::short_inverted_list::eq                 ... bench:         580 ns/iter (+/- 66)
test derived_eq::short_list::eq                          ... bench:         467 ns/iter (+/- 14)
test robust::degenerate_cyclic::equiv                    ... bench:       2,995 ns/iter (+/- 9)
test robust::degenerate_cyclic::precheck_equiv           ... bench:       6,610 ns/iter (+/- 310)
test robust::degenerate_dag::equiv                       ... bench:       2,911 ns/iter (+/- 58)
test robust::degenerate_dag::precheck_equiv              ... bench:       6,288 ns/iter (+/- 204)
test robust::inverted_list::equiv                        ... bench:     189,656 ns/iter (+/- 41,536)
test robust::inverted_list::precheck_equiv               ... bench:     222,418 ns/iter (+/- 66,203)
test robust::list::equiv                                 ... bench:     197,206 ns/iter (+/- 120,107)
test robust::list::precheck_equiv                        ... bench:     202,847 ns/iter (+/- 18,732)
test robust::long_degenerate_cyclic::equiv               ... bench: 109,536,041 ns/iter (+/- 7,421,641)
test robust::long_degenerate_cyclic::precheck_equiv      ... bench: 115,675,577 ns/iter (+/- 8,742,047)
test robust::long_degenerate_dag::equiv                  ... bench: 107,448,925 ns/iter (+/- 8,455,577)
test robust::long_degenerate_dag::precheck_equiv         ... bench: 112,628,060 ns/iter (+/- 8,942,630)
test robust::long_inverted_list::equiv                   ... bench:  12,741,035 ns/iter (+/- 1,231,534)
test robust::long_inverted_list::precheck_equiv          ... bench:  14,546,166 ns/iter (+/- 938,584)
test robust::long_list::equiv                            ... bench:   8,885,613 ns/iter (+/- 1,247,825)
test robust::long_list::precheck_equiv                   ... bench:  15,996,239 ns/iter (+/- 1,782,683)
test robust::short_degenerate_cyclic::equiv              ... bench:       1,349 ns/iter (+/- 57)
test robust::short_degenerate_cyclic::precheck_equiv     ... bench:       4,902 ns/iter (+/- 101)
test robust::short_degenerate_dag::equiv                 ... bench:       1,286 ns/iter (+/- 53)
test robust::short_degenerate_dag::precheck_equiv        ... bench:       2,146 ns/iter (+/- 103)
test robust::short_inverted_list::equiv                  ... bench:       6,244 ns/iter (+/- 114)
test robust::short_inverted_list::precheck_equiv         ... bench:       1,663 ns/iter (+/- 23)
test robust::short_list::equiv                           ... bench:       3,950 ns/iter (+/- 185)
test robust::short_list::precheck_equiv                  ... bench:       1,560 ns/iter (+/- 11)

test result: ok. 0 passed; 0 failed; 0 ignored; 66 measured; 0 filtered out; finished in 268.60s
```
